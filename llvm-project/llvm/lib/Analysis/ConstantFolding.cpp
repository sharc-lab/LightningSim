...
Constant *constantFoldPartSelect(ArrayRef<Constant *> Operands) {
...
Constant *constantFoldPartSet(ArrayRef<Constant *> Operands) {
...
static Constant *ConstantFoldScalarCall1(StringRef Name,
  ...
  default: break;
  case Intrinsic::part_select:
    if (Constant *C = constantFoldPartSelect(Operands))
      return C;
    break;
  case Intrinsic::part_set:
    if (Constant *C = constantFoldPartSet(Operands))
      return C;
    break;
  }
